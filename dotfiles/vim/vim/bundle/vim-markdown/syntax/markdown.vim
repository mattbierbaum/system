...
" Ignore the latex stuff
syn region latexinline start="\$"   end="\$"  contains=@Latex
syn region latexmath   start="\$\$" end="\$\$" contains=@Latex

if exists('cur_syntax')
